...
// Read environment at runtime — never hardcode infra details
const ENV_INFO = [
  { k: "Environment", v: import.meta.env.MODE === "production" ? "Production" : import.meta.env.MODE ?? "Unknown" },
  { k: "Platform",    v: import.meta.env.VITE_APP_NAME ?? "Phenomebeauty" },
      ...
      <GlassCard>
        ...
        <div className="p-5 space-y-4">
          <div className="space-y-1">
            ...
            <input id="sa-new-password" name="sa-new-password" type="password" value={newPw} onChange={e => setNewPw(e.target.value)}
          ...
          <div className="space-y-1">
            ...
            <input id="sa-confirm-password" name="sa-confirm-password" type="password" value={confirmPw} onChange={e => setConfirmPw(e.target.value)}
          ...
          <button onClick={changePassword} disabled={pwStatus === "loading"}
