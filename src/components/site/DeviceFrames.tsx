...
export const LaptopFrame = ({ children, interactive = true }: DeviceFrameProps) => (
  ...
  >
    <div className="rounded-t-[10px] bg-[#1a1a1a] border-[2px] border-b-0 border-[#2a2a2a] p-[5px] pt-[5px]">
      ...
      <div
        className={`rounded-[3px] overflow-hidden bg-[hsl(0,0%,4%)] ${!interactive ? "pointer-events-none select-none" : ""}`}
...
export const MobileFrame = ({ children, interactive = true }: DeviceFrameProps) => (
  ...
  >
    ...
    <div className="rounded-[22%/8%] overflow-hidden border-[2px] border-[#3a3a3a] bg-black p-[3px]">
      ...
      {/* Screen */}
      <div
        className="relative rounded-[20%/7%] overflow-hidden bg-black flex flex-col"
