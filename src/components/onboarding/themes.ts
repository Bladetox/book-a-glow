...
export const businessThemes: OnboardingTheme[] = [
  {
    ...
    colors: {
      ...
      // background: 88% lightness — all text values verified WCAG AA
      // foreground 7%  → contrast ~13:1 AAA
      // mutedForeground 20% → contrast ~7.5:1 AA on 88% bg
      // accentForeground 7% → contrast ~13:1 on accent (60% lightness)
      background: "30 45% 88%",
      foreground: "0 0% 7%",
      card: "30 38% 84%",
  ...
  },
  {
    ...
    colors: {
      ...
      // background: 92% lightness
      // foreground 8%  → contrast ~14:1 AAA
      // mutedForeground 20% → contrast ~8:1 AA on 92% bg
      background: "80 25% 92%",
      foreground: "150 15% 8%",
      card: "80 20% 88%",
  ...
  },
  {
    ...
    colors: {
      // Dark theme — contrast already excellent
      // foreground 92% on 5% bg → contrast ~18:1 AAA
      // mutedForeground 62% on 5% bg → contrast ~9:1 AA
      background: "0 5% 5%",
      foreground: "0 0% 92%",
      card: "0 8% 10%",
  ...
  },
  {
    ...
    colors: {
      ...
      // background: 86% lightness
      // foreground 8%  → contrast ~13:1 AAA
      // mutedForeground 18% → contrast ~8.5:1 AA on 86% bg
      // accent darkened to 38% lightness — accentForeground white → ~5:1 AA
  ...
  },
  {
    ...
    colors: {
      // Dark navy theme — contrast already excellent
      // foreground 92% on 15% bg → contrast ~10:1 AA
      // mutedForeground 65% on 15% bg → contrast ~5.5:1 AA
  ...
  },
  {
    ...
    colors: {
      ...
      // background: 87% lightness
      // foreground 7%  → contrast ~13.5:1 AAA
      // mutedForeground 18% → contrast ~9:1 AA on 87% bg
      // accent darkened to 35% — accentForeground white → ~5.5:1 AA
  ...
  },
  {
    ...
    colors: {
      // Pure white theme
      // foreground 7%  → contrast ~16:1 AAA on white
      // mutedForeground 28% → contrast ~6:1 AA on white
      // accent 18% lightness with white foreground was wrong — flipped:
      // accent kept at mid-gray 55%, accentForeground near-black 7%
      background: "0 0% 100%",
      foreground: "0 0% 7%",
      card: "0 0% 97%",
      cardForeground: "0 0% 7%",
