    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="m-3 md:m-4 mt-10 md:mt-12 rounded-2xl bg-[#151515] border border-white/[0.08] flex flex-col max-h-[calc(100%-100px)] pointer-events-auto overflow-hidden"
        >
          {/* Header */}
