...
const integrations = [
  {
    icon: "💳", name: "Yoco Payments", desc: "Online checkout, deposit & balance collection",
  ...
  {
    icon: "📅", name: "Google Calendar", desc: "Auto-creates events when deposits are confirmed",
  ...
  {
    icon: "🗺️", name: "Google Maps", desc: "Distance matrix for callout fee calculation",
  ...
  {
    icon: "✉️", name: "Gmail / SMTP", desc: "Transactional emails to customers and admin",
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <h3 className="font-display text-2xl font-bold text-white/90">Integrations</h3>
