                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-gray-900 truncate">{client.client_name}</h3>
                      ...
                      <div className="flex flex-col sm:items-end gap-1">
                        ...
                        <span className="text-xs text-gray-500 whitespace-nowrap">
                          Due: {client.next_due_date ? new Date(client.next_due_date).toLocaleDateString() : "—"}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                inactiveClients.map((client) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-gray-900 truncate">{client.client_name}</h3>
                        <p className="text-sm text-gray-600 truncate">{client.client_phone}</p>
                      </div>
                      <div className="flex flex-col sm:items-end gap-1">
