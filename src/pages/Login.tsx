...
const Login = () => (
  <div className="min-h-screen nextslot-theme bg-background">
    ...
    <main className="max-w-sm mx-auto px-4 py-24">
      ...
      <p className="text-sm text-muted-foreground text-center mt-6">Don't have an account? <Link to="/signup" className="text-foreground font-medium hover:underline">Create one</Link></p>
    </main>
  </div>
);
