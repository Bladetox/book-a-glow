...
const painPoints = [
  {
    ...
    body: "You're managing 10 conversations at once, trying to remember who confirmed and who didn't.",
  },
  {
    icon: "💸",
  ...
  return (
    <div className="min-h-screen nextslot-theme bg-background overflow-x-hidden">
      ...
      <main>
        ...
        {/* ── 2. PAIN POINTS ─────────────────────────────────────────────── */}
        <section className="w-full py-20 md:py-28" style={{ background: "hsl(220 20% 6%)" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

            <div className="text-center mb-4">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-5"
                style={{ background: "hsl(0 72% 51% / 0.12)", border: "1px solid hsl(0 72% 51% / 0.30)" }}
              >
              ...
              <p className="text-white/50 text-sm max-w-md mx-auto">
                These aren't minor inconveniences. They're costing you clients, revenue, and your peace of mind every single day.
              </p>
            </div>

            {/* Pain point cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-10 mb-12">
              {painPoints.map((p) => (
                <div
                  key={p.heading}
                  ...
                  style={{
                    ...
                    boxShadow: "0 4px 20px hsl(0 72% 51% / 0.07)",
                  }}
                >
            ...
            <div className="text-center mt-10">
              <div className="inline-flex items-center gap-3 rounded-2xl px-6 py-4 ring-1"
                style={{
                  background: "hsl(var(--foreground))",
                  color: "hsl(var(--background))",
                  boxShadow: "0 6px 24px -6px hsl(var(--accent)/0.4)",
