-- Fix: consultations INSERT missing tenant_id in create_booking_with_consultation
-- The consultations table has tenant_id NOT NULL, but the RPC never passed it.
-- We derive it from the booking's tenant_id via the bookings table after insert.
