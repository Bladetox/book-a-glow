...
const THEME_COPY: Record<string, ThemeCopy> = {
  makeup_artist: {
    ...
    success_deposit_body:
      "Your deposit is in and your appointment is secured. Arrive with a clean, moisturised face for best results.",
    ...
    success_final_body:
      "Your booking is confirmed. We'll send a reminder closer to the date.",
  ...
  beautician: {
    ...
    success_deposit_body:
      "Your deposit is confirmed and your treatment is locked in. Stay hydrated and avoid heavy skincare the night before.",
    ...
    success_final_rebook:
      "Consistency is key — book your next treatment now.",
  ...
  tattoo_artist: {
    ...
    confirmation_intro:
      "Your slot is locked. Come hydrated, fed, and ready to commit.",
    confirmation_outro:
      "Let's make something you'll love forever.",
    success_deposit_title: "Deposit received — you're on the books",
    success_deposit_tagline: "The ink will be worth it.",
    success_deposit_body:
      "Your deposit is in. Your session is secured. Eat a solid meal beforehand and avoid alcohol for 24 hours.",
    ...
    success_final_body:
      "Your tattoo session is confirmed. Check your aftercare notes and arrive prepared.",
    success_final_rebook:
      "Got another piece in mind? Book your next session.",
  ...
  lash_tech: {
    ...
    confirmation_intro:
      "Your slot is held. Come with clean, makeup-free lashes.",
    ...
    success_deposit_body:
      "Your deposit is confirmed. Arrive with no mascara or eye makeup — clean lashes only.",
    success_deposit_intent:
      "Excited to give you the lashes you deserve.",
    ...
    success_final_body:
      "Your appointment is locked in. We'll see you soon with clean lashes ready to go.",
    success_final_rebook:
      "Infills are due every 2–3 weeks — don't wait too long!",
  ...
  barber: {
    ...
    success_deposit_body:
      "Your deposit is in and your appointment is confirmed. Come as you are.",
    ...
    success_final_body:
      "Your appointment is confirmed. We'll see you when you get here.",
    success_final_rebook:
      "Regular cuts keep the fade fresh — rebook in 2–4 weeks.",
  ...
  nail_tech: {
    ...
    confirmation_intro:
      "Your slot is reserved — come ready to pick your colour.",
    ...
    success_deposit_body:
      "Your deposit is received and your nail appointment is secured. Remove any existing gel or acrylics beforehand if possible.",
    ...
    success_final_body:
      "You're all booked. We'll see you soon for your nail session.",
    success_final_rebook:
      "Infills needed in 2–3 weeks — book ahead so you don't miss your slot.",
...
const THEME_COLORS: Record<string, ThemeColors> = {
  makeup_artist: {
    ...
    primary: "0 0% 7%",
    primary_foreground: "30 45% 95%",
    secondary: "30 32% 82%",
    secondary_foreground: "0 0% 7%",
    muted: "30 28% 83%",
    muted_foreground: "0 0% 35%",
    accent: "38 55% 60%",
    accent_foreground: "0 0% 7%",
    border: "30 30% 75%",
    input: "30 30% 77%",
    ring: "338 60% 55%",
    gradient_hero:
      "linear-gradient(180deg, hsl(30 45% 88%) 0%, hsl(30 38% 84%) 100%)",
    gradient_card:
      "linear-gradient(135deg, hsl(30 42% 86%) 0%, hsl(30 35% 83%) 100%)",
    gradient_surface:
      "linear-gradient(180deg, hsl(30 42% 87%) 0%, hsl(30 32% 84%) 100%)",
  },
  beautician: {
    background: "80 25% 92%",
    foreground: "150 15% 12%",
    card: "80 20% 88%",
    card_foreground: "150 15% 12%",
    primary: "150 20% 28%",
    primary_foreground: "80 25% 96%",
    secondary: "80 18% 86%",
    secondary_foreground: "150 15% 12%",
    muted: "80 15% 87%",
    muted_foreground: "150 8% 42%",
    accent: "160 25% 65%",
    accent_foreground: "150 15% 12%",
    border: "80 15% 80%",
    input: "80 15% 82%",
    ring: "150 20% 28%",
    gradient_hero:
      "linear-gradient(180deg, hsl(80 25% 92%) 0%, hsl(80 20% 88%) 100%)",
    gradient_card:
      "linear-gradient(135deg, hsl(80 22% 90%) 0%, hsl(80 18% 87%) 100%)",
    gradient_surface:
      "linear-gradient(180deg, hsl(80 22% 91%) 0%, hsl(80 16% 88%) 100%)",
  },
  tattoo_artist: {
    background: "0 5% 5%",
    foreground: "0 0% 92%",
    ...
    ring: "0 80% 48%",
    gradient_hero:
      "linear-gradient(180deg, hsl(0 5% 5%) 0%, hsl(0 8% 3%) 100%)",
    gradient_card:
      "linear-gradient(135deg, hsl(0 8% 10%) 0%, hsl(0 5% 8%) 100%)",
    gradient_surface:
      "linear-gradient(180deg, hsl(0 8% 10%) 0%, hsl(0 5% 8%) 100%)",
  },
  lash_tech: {
    background: "340 45% 86%",
    foreground: "340 20% 10%",
    card: "340 38% 82%",
    card_foreground: "340 20% 10%",
    primary: "340 35% 22%",
    primary_foreground: "340 45% 95%",
    secondary: "340 32% 80%",
    secondary_foreground: "340 20% 10%",
    muted: "340 28% 81%",
    muted_foreground: "340 12% 38%",
    accent: "270 40% 65%",
    accent_foreground: "340 20% 10%",
    border: "340 28% 74%",
    input: "340 28% 76%",
    ring: "38 40% 65%",
    gradient_hero:
      "linear-gradient(180deg, hsl(340 45% 86%) 0%, hsl(340 38% 82%) 100%)",
    gradient_card:
      "linear-gradient(135deg, hsl(340 42% 84%) 0%, hsl(340 35% 81%) 100%)",
    gradient_surface:
      "linear-gradient(180deg, hsl(340 42% 85%) 0%, hsl(340 35% 82%) 100%)",
  },
  barber: {
    background: "210 15% 15%",
    foreground: "210 10% 92%",
    card: "210 12% 20%",
    card_foreground: "210 10% 92%",
    primary: "0 65% 50%",
    primary_foreground: "0 0% 100%",
    secondary: "210 12% 22%",
    secondary_foreground: "210 10% 92%",
    muted: "210 10% 22%",
    muted_foreground: "210 8% 58%",
    accent: "25 40% 40%",
    accent_foreground: "0 0% 100%",
    border: "210 10% 26%",
    input: "210 10% 26%",
    ring: "0 65% 50%",
    gradient_hero:
      "linear-gradient(180deg, hsl(210 15% 15%) 0%, hsl(210 12% 12%) 100%)",
    gradient_card:
      "linear-gradient(135deg, hsl(210 14% 18%) 0%, hsl(210 10% 15%) 100%)",
    gradient_surface:
      "linear-gradient(180deg, hsl(210 14% 17%) 0%, hsl(210 10% 14%) 100%)",
  },
  nail_tech: {
    background: "330 38% 87%",
    foreground: "330 15% 8%",
    card: "330 32% 83%",
    card_foreground: "330 15% 8%",
    primary: "330 15% 8%",
    primary_foreground: "330 38% 95%",
    secondary: "330 28% 81%",
    secondary_foreground: "330 15% 8%",
    muted: "330 24% 82%",
    muted_foreground: "330 8% 38%",
    accent: "330 75% 55%",
    accent_foreground: "0 0% 100%",
    border: "330 25% 75%",
    input: "330 25% 77%",
    ring: "38 50% 60%",
    gradient_hero:
      "linear-gradient(180deg, hsl(330 38% 87%) 0%, hsl(330 32% 83%) 100%)",
    gradient_card:
      "linear-gradient(135deg, hsl(330 35% 85%) 0%, hsl(330 28% 82%) 100%)",
    gradient_surface:
      "linear-gradient(180deg, hsl(330 35% 86%) 0%, hsl(330 28% 83%) 100%)",
  },
  standard: {
    background: "0 0% 100%",
    foreground: "0 0% 7%",
    ...
    gradient_card:
      "linear-gradient(135deg, hsl(0 0% 100%) 0%, hsl(0 0% 98%) 100%)",
    gradient_surface:
...
function generateSlots(
  ...
  while (cur + 30 <= endMins) {
    slots.push({
      slot_start_time: toTime(cur),
      slot_end_time: toTime(cur + 30),
    });
    cur += 30;
  }
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (existingOwnerRole?.tenant_id) {
      return json({
        error: "User already owns a tenant",
        tenant_id: existingOwnerRole.tenant_id,
      }, 409);
    }
    ...
    const validServices = (services as Array<{
      name?: string;
      price?: string;
      duration?: string;
    ...
    if (validServices.length > 0) {
      const rows = validServices.map((s) => ({
        ...
        duration_minutes: parseInt(s.duration ?? "30", 10) || 30,
        category,
        is_active: true,
      }));
      ...
      const { error: svcErr } = await admin
        .from("services")
        .upsert(rows, {
          onConflict: "tenant_id,name,category",
    ...
    const defaultSettings: { key: string; value: string; description: string | null }[] = [
      ...
      {
        key: "fixed_origin_address",
        value: "",
        description: "Fixed origin for distance calculations",
      },
      ...
      { key: "yoco_public_key", value: "", description: null },
      {
        key: "yoco_secret_key",
        value: "",
        description: "Yoco secret key for payment API",
      },
      {
      ...
      },
      {
        ...
        value: "",
        description: "Google Calendar ID for bookings",
      },
...

      {
        ...
        value: "",
        description: "Loyalty: loyalty_qualifying_service",
      },
      {
        key: "loyalty_min_bookings",
        value: "3",
        description: "Loyalty: loyalty_min_bookings",
      },
      {
        key: "loyalty_lookback_days",
        value: "90",
        description: "Loyalty: loyalty_lookback_days",
      },
      {
        key: "loyalty_reminder_weeks",
        value: "5",
        description: "Loyalty: loyalty_reminder_weeks",
      },

      {
        key: "theme_background",
        value: colors.background,
        description: "CSS --background HSL value",
      },
      {
        key: "theme_foreground",
        value: colors.foreground,
        description: "CSS --foreground HSL value",
      },
      {
        key: "theme_card",
        value: colors.card,
        description: "CSS --card HSL value",
      },
      {
        key: "theme_card_foreground",
        value: colors.card_foreground,
        description: "CSS --card-foreground HSL value",
      },
      {
        key: "theme_primary",
        value: colors.primary,
        description: "CSS --primary HSL value",
      },
      {
        key: "theme_primary_foreground",
        value: colors.primary_foreground,
        description: "CSS --primary-foreground HSL value",
      },
      {
        key: "theme_secondary",
        value: colors.secondary,
        description: "CSS --secondary HSL value",
      },
      {
        key: "theme_secondary_foreground",
        value: colors.secondary_foreground,
        description: "CSS --secondary-foreground HSL value",
      },
      {
        key: "theme_muted",
        value: colors.muted,
        description: "CSS --muted HSL value",
      },
      {
        key: "theme_muted_foreground",
        value: colors.muted_foreground,
        description: "CSS --muted-foreground HSL value",
      },
      {
        key: "theme_accent",
        value: colors.accent,
        description: "CSS --accent HSL value",
      },
      {
        key: "theme_accent_foreground",
        value: colors.accent_foreground,
        description: "CSS --accent-foreground HSL value",
      },
      {
        key: "theme_border",
        value: colors.border,
        description: "CSS --border HSL value",
      },
      {
        key: "theme_input",
        value: colors.input,
        description: "CSS --input HSL value",
      },
      {
        key: "theme_ring",
        value: colors.ring,
        description: "CSS --ring HSL value",
      },
      {
        key: "theme_gradient_hero",
        value: colors.gradient_hero,
        description: "CSS --gradient-hero value",
      },
      {
        key: "theme_gradient_card",
        value: colors.gradient_card,
        description: "CSS --gradient-card value",
      },
      {
        key: "theme_gradient_surface",
        value: colors.gradient_surface,
        description: "CSS --gradient-surface value",
      },
    ];
